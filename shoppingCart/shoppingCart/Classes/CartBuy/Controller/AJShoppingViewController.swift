...
class AJShoppingViewController: UIViewController {
    ...
    lazy var selectButton: UIButton = {
        ...
        selectButton.set(image: UIImage(named: "check_n"), title: "多选\\反选", titlePosition: .right, additionalSpacing: 5, state: .normal)
        selectButton.set(image: UIImage(named: "check_p"), title: "多选\\反选", titlePosition: .right, additionalSpacing: 5, state: .selected)
        selectButton.setTitleColor(UIColor.gray, for: UIControlState())
        selectButton.titleLabel?.font = UIFont.systemFont(ofSize: 12)
        selectButton.addTarget(self, action:#selector(didSelectButton(_:)), for: UIControlEvents.touchUpInside)
        //默认是已经选择的状态
...
extension UIButton {
    ...
    @objc func set(image anImage: UIImage?, title: String,
        ...
        self.setImage(anImage, for: UIControlState())
